...
void driver_auglag(int I, int n, int max_feval, int max_minor,
                   ...
                   double (*eval_f)(int I, int n, double *x, double *param,
                                    double YffR, double YffI, double YftR, double YftI,
                                    double YttR, double YttI, double YtfR, double YtfI),
                   void (*eval_g)(int I, int n, double *x, double *g, double *param,
                                  double YffR, double YffI, double YftR, double YftI,
                                  double YttR, double YttI, double YtfR, double YtfI),
                   void (*eval_h)(int I, int n, double *x, double *H, double *param,
                                  double YffR, double YffI, double YftR, double YftI,
                                  double YttR, double YttI, double YtfR, double YtfI))
{
    int task, status, cg_itermax;
    ...
    while (search) {
        ...
        if (task == 0 || task == 1) {
            f = eval_f(I, n, x, param, YffR, YffI, YftR, YftI, YttR, YttI, YtfR, YtfI);
            nfev += 1;
            if (nfev >= max_feval) {
                search = false;
            }
        ...
        if (task == 0 || task == 2) {
            eval_g(I, n, x, g, param, YffR, YffI, YftR, YftI, YttR, YttI, YtfR, YtfI);
            eval_h(I, n, x, A, param, YffR, YffI, YftR, YftI, YttR, YttI, YtfR, YtfI);
            ngev += 1;
            nhev += 1;
            minor_iter += 1;
        }
